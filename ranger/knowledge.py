...
class KnowledgeLoader:
    ...
    def load(self, query: str | None = None) -> KnowledgeContext:
        ...
        for item in files:
            ...
            if used + len(body) > self.config.budget_chars:
        ...
        if omitted:
            warnings.append(
                f"knowledge exceeded the {self.config.budget_chars} character budget; "
